...
INSERT INTO Item (ItemID, UserID, CategoryID, TypeID, ItemName, Brand, Model, Dimension, Condition, Dsetail, Price, ImageURL, IsSold) VALUES (7, 7, 3, 7, 'Amazing harry potter lego', 'LEGO', 'Harry Potter Hogwarts Castle', 'M', 'New', 'LEGO Harry Potter Hogwarts Castle set with minifigures.', 199.99, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4Fb7sNSareJuK0r2sRPxlc4LCqN4PLfE5ztN4jd_X7A&s', 0);

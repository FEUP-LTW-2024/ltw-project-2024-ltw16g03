        ...
        if (sizeOptionsSell) {
            switch (categoryName) {
                ...
                case "Men":
                    ...
                    <label><input type="radio" name="SIZE" value="XXS">XXS</label>
                    <h2>SHOES SIZE</h2>
                    ...
                    <label><input type="radio" name="SIZE" value="47">47</label>
                    <label><input type="radio" name="SIZE" value="48">48</label>
                    <label><input type="radio" name="SIZE" value="49">49</label>
                    <label><input type="radio" name="SIZE" value="50">50</label>
                    `;
                    break;
                case "Kids":
                    sizeOptionsSell.innerHTML = `
                    <h2>CLOTHES SIZE</h2>
                    <label><input type="radio" name="SIZE" value="2-3 years">2-3 years</label>
                    <label><input type="radio" name="SIZE" value="3-4 years">3-4 years</label>
                    <label><input type="radio" name="SIZE" value="4-5 years">4-5 years</label>
                    <label><input type="radio" name="SIZE" value="5-6 years">5-6 years</label>
                    <label><input type="radio" name="SIZE" value="6-7 years">6-7 years</label>
                    <label><input type="radio" name="SIZE" value="7-8 years">7-8 years</label>
                    <label><input type="radio" name="SIZE" value="9-10 years">9-10 years</label>
                    <label><input type="radio" name="SIZE" value="10-11 years">10-11 years</label>
                    <label><input type="radio" name="SIZE" value="11-12 years">11-12 years</label>
                    <label><input type="radio" name="SIZE" value="12-13 years">12-13 years</label>
                    <label><input type="radio" name="SIZE" value="13-14 years">13-14 years</label>
                    <label><input type="radio" name="SIZE" value="14-15 years">14-15 years</label>
                    <label><input type="radio" name="SIZE" value="15-16 years">15-16 years</label>
                    <h2>SHOES SIZE</h2>
                    <label><input type="radio" name="SIZE" value="15">15</label>
                    <label><input type="radio" name="SIZE" value="16">16</label>
                    <label><input type="radio" name="SIZE" value="17">17</label>
                    <label><input type="radio" name="SIZE" value="18">18</label>
                    <label><input type="radio" name="SIZE" value="19">19</label>
                    <label><input type="radio" name="SIZE" value="20">20</label>
                    <label><input type="radio" name="SIZE" value="21">21</label>
                    <label><input type="radio" name="SIZE" value="22">22</label>
                    <label><input type="radio" name="SIZE" value="23">23</label>
                    <label><input type="radio" name="SIZE" value="24">24</label>
                    <label><input type="radio" name="SIZE" value="25">25</label>
                    <label><input type="radio" name="SIZE" value="26">26</label>
                    <label><input type="radio" name="SIZE" value="27">27</label>
                    <label><input type="radio" name="SIZE" value="28">28</label>
                    <label><input type="radio" name="SIZE" value="29">29</label>
                    <label><input type="radio" name="SIZE" value="30">30</label>
                    <label><input type="radio" name="SIZE" value="31">31</label>
                    <label><input type="radio" name="SIZE" value="32">32</label>
                    <label><input type="radio" name="SIZE" value="33">33</label>
                    <label><input type="radio" name="SIZE" value="34">34</label>
                    <label><input type="radio" name="SIZE" value="35">35</label>
                ...
                case "Baby":
                    sizeOptionsSell.innerHTML = `
                    <h2>SIZE</h2>
                    <label><input type="radio" name="SIZE" value="0-3 months">0-3 months</label>
                    <label><input type="radio" name="SIZE" value="3-6 months">3-6 months</label>
                    <label><input type="radio" name="SIZE" value="6-9 months">6-9 months</label>
                    <label><input type="radio" name="SIZE" value="9-12 months">9-12 months</label>
                    <label><input type="radio" name="SIZE" value="12-18 months">12-18 months</label>
                    <label><input type="radio" name="SIZE" value="18-24 months">18-24 months</label>`
                    break;
                default:
                    break;
            }
